...
class MedicineSearchViewController: UIViewController, UISearchBarDelegate {
...
//    @IBOutlet weak var activityIndicator: UIActivityIndicatorView!
    ...
    lazy var contentView: MedicineSearchView = {
        let view = MedicineSearchView()
        return view
    }()
...
//            MyMedicinesController.medicines.append(medicine)
